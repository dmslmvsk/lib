  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-200 p-6 md:p-12">
      <div className="container mx-auto max-w-5xl">
        ...
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-zinc-500 hover:text-indigo-500 transition-colors mb-12 text-sm font-medium"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <div className="aspect-3/4 rounded-sm bg-zinc-900 border border-zinc-800 flex items-center justify-center relative group overflow-hidden">
              <span className="text-9xl font-bold text-zinc-800 select-none group-hover:text-indigo-500/20 transition-colors duration-500">
                {book.title[0]}
              </span>
              
              <div className="absolute top-4 right-4">
                 <div className={`px-2.5 py-1 rounded-sm border text-[10px] font-bold uppercase tracking-wider ${
                    isBorrowed 
          ...
          <div className="md:col-span-7 lg:col-span-8 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-8 border-y border-zinc-900">
            ...
            <div className="pt-6">
              <Button 
                  ...
                  className={`min-w-50 rounded-sm font-bold text-sm h-12 transition-all hover:cursor-pointer ${
                    isBorrowed 
